...
architecture behavioral of fcs_check_parallel is
  ...
  signal Counter       : unsigned(2 downto 0);		-- Counter that counts number of times 8 bits have been sendt
...
begin
	...
	Begin
		...
		Reg(0) <= Reg(24) xor Reg(30) xor data_in(0);
		Reg(1) <= Reg(24) xor Reg(25) xor Reg(30) xor Reg(31) xor data_in(1);
		Reg(2) <= Reg(24) xor Reg(25) xor Reg(26) xor Reg(30) xor Reg(31) xor data_in(2);
		Reg(3) <= Reg(25) xor Reg(26) xor Reg(27) xor Reg(31) xor data_in(3);
		Reg(4) <= Reg(24) xor Reg(26) xor Reg(27) xor Reg(28) xor Reg(30) xor data_in(4);
		Reg(5) <= Reg(24) xor Reg(25) xor Reg(27) xor Reg(28) xor Reg(29) xor Reg(30) xor Reg(31) xor data_in(5);
		Reg(6) <= Reg(25) xor Reg(26) xor Reg(28) xor Reg(29) xor Reg(30) xor Reg(31) xor data_in(6);
		Reg(7) <= Reg(24) xor Reg(26) xor Reg(27) xor Reg(29) xor Reg(31) xor data_in(7);
