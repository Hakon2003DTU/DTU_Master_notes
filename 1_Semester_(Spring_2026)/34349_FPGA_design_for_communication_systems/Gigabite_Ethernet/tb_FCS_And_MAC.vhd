...
architecture behavior of tb_FCS_And_MAC is
 ...
 -- Constants
	...
	constant Destination_MAC_1	: std_logic_vector(47 downto 0) := x"000000000008";
	constant Destination_MAC_2	: std_logic_vector(47 downto 0) := x"000000000007";
	constant Destination_MAC_3	: std_logic_vector(47 downto 0) := x"000000000006";
	constant Destination_MAC_4	: std_logic_vector(47 downto 0) := x"000000000005";
	constant Source_MAC_1		: std_logic_vector(47 downto 0) := x"000000000004";
	constant Source_MAC_2		: std_logic_vector(47 downto 0) := x"000000000003";
	constant Source_MAC_3		: std_logic_vector(47 downto 0) := x"000000000002";
	constant Source_MAC_4		: std_logic_vector(47 downto 0) := x"000000000001";
	constant Ethernetlength_1 	: std_logic_vector(15 downto 0) := x"002E";
	constant Ethernetlength_2 	: std_logic_vector(15 downto 0) := x"002E";
	constant Ethernetlength_3 	: std_logic_vector(15 downto 0) := x"002E";
	constant Ethernetlength_4 	: std_logic_vector(15 downto 0) := x"002E";
	constant FCS_1			: std_logic_vector(31 downto 0) := x"796A741F";
	constant FCS_2			: std_logic_vector(31 downto 0) := x"F528F61C";
	constant FCS_3			: std_logic_vector(31 downto 0) := x"586CA664";
	constant FCS_4			: std_logic_vector(31 downto 0) := x"AB614B5B";
	constant Dunmmy			: std_logic_vector(7 downto 0)	:= x"FF";
  
  -- Clock Speed
  constant Tx_Clk_period   : time := 5 ns;
  constant Rx_Clk_1_period : time := 5 ns;
  constant Rx_Clk_2_period : time := 5 ns;
  constant Rx_Clk_3_period : time := 5 ns;
  constant Rx_Clk_4_period : time := 5 ns;


  begin

 	-- Wireing componant to signals
...
-- Generating the CLK's

-- Clock generation Tx 
  Clk_Generator_Tx : process
  begin
    test_Tx_Clk <= '0';
...
-- Clock generation 2 
  ...
  begin
    test_Rx_Clk_2 <= '0';
    wait for Rx_Clk_2_period/2;
    test_Rx_Clk_2 <= '1';
    wait for Rx_Clk_2_period/2;
  end process;

-- Clock generation 3 
  Clk_Generator3 : process
  begin
    test_Rx_Clk_3 <= '0';
    wait for Rx_Clk_3_period/2;
    test_Rx_Clk_3 <= '1';
    wait for Rx_Clk_3_period/2;
  end process;

-- Clock generation 4 
  Clk_Generator4 : process
  begin
    test_Rx_Clk_4 <= '0';
    wait for Rx_Clk_4_period/2;
    test_Rx_Clk_4 <= '1';
    wait for Rx_Clk_4_period/2;
  end process;


  -- Data_Simulation(Set the Signals to the desired values)
  Data_Sim : process
  begin

  -- Start by inserting data
	wait for Rx_Clk_1_period;
